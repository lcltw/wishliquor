                      ...
                      .map((icon, idx) => (
                        <div className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg border">
                          <div
                            ...
                            className={`flex items-center gap-1 cursor-grab select-none transition-all ${draggingIcon === icon.id ? "opacity-30" : ""} ${overIcon === icon.id && draggingIcon !== icon.id ? "ring-2 ring-amber-400" : ""}`}
                          >
