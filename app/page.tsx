...
interface CartItem {
  id: number; name: string; brand: string; country: string; category: string; age: string; volume: string; price: number; img: string; qty: number;
}
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <a href="/" className="flex items-center gap-3">
                <div style={{ backgroundColor: s.primary, color: '#fff' }} className="font-bold px-3 py-1.5 text-lg">{siteSettings.logo}</div>
                <span className="font-semibold hidden sm:block" style={{ color: s.text }}>{siteSettings.siteName}</span>
              </a>
            </div>
